...
namespace viewer
{
  IGL_INLINE void Viewer::init()
  {
    ...
    nanogui::Window *window = ngui->addWindow(Eigen::Vector2i(10,10),"Structure Simplification");
    // ---------------------- LOADING ----------------------
	...
	WireframeCBox->setChecked(core.show_lines);
  ...
  IGL_INLINE int  Viewer::launch_init(bool resizable,bool fullscreen)
  {
    ...
    if(fullscreen)
    {
      ...
      window = glfwCreateWindow(mode->width,mode->height,"Hex-mesh Simplification",monitor,nullptr);
    }
    else
    {
      //window = glfwCreateWindow(1280,800,"libigl viewer",nullptr,nullptr);
		window = glfwCreateWindow(1920, 1080, "Hex-mesh Simplification", nullptr, nullptr);
    }
